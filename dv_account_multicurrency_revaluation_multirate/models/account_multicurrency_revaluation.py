    ...
    def _get_sql(self):
        ...
        return """
            SELECT {move_line_fields},
                   ...
                   custom_currency_table.currency_id                    AS report_currency_id,
                   account.code                                         AS account_code,
                   account.name                                         AS account_name,
                   custom_currency_table.currency_name                  AS currency_code,
            ...
            WHERE (account.currency_id != aml.company_currency_id OR account.currency_id IS NULL) AND account.currency_multirate_affected = TRUE
            {account_query}
            UNION ALL
